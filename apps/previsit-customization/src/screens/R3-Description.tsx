...
export default function R3Description() {
                    ...
                    <React.Fragment key={id}>
                      ...
                      >
                        ...
                        <div className="flex items-center gap-[8px] min-h-[28px] px-[4px] py-[5px]">
                          <div
                            className="shrink-0 leading-[0] text-[var(--foreground-secondary,#666)] cursor-grab touch-none select-none self-start mt-[2px]"
                            onPointerDown={(e) => {
                              ...
                              return (
                                <React.Fragment key={child.id}>
                                  ...
                                  <div
                                    ...
                                    className={[
                                      "group/child-row flex items-center gap-[8px] min-h-[28px] px-[4px] py-[4px] transition-opacity",
                                      isSubDragging ? "opacity-40" : "opacity-100",
                                    ].join(" ")}
                                  >
                                    <div
                                      className="shrink-0 leading-[0] text-[var(--foreground-secondary,#666)] cursor-grab touch-none select-none opacity-0 group-hover/child-row:opacity-100 transition-opacity self-start mt-[1px]"
                                      onPointerDown={(e) => {
                                        e.currentTarget.setPointerCapture(e.pointerId);
